...
//키값이 같다면 각 변수에 데이터삽입
 ...
 if ($mode == 2){
   ...
   $sum1=0.0;
   for($i=0;$i<$number;$i++){
      $sum1 = $sum1+$lat_Array[$i];
   }
   $lat55 = $sum1 / $number;

   $sum2 = 0.0;
   for($j=0;$j<$number;$j++){
      $sum2 = $sum2+$lng_Array[$j];
   }
   $lng55 = $sum2 / $number;
 }
...
<body>
  ...
  <form id=setplaceform name="setplaceform" method="post" action="http://ttakmanna.com/ttak/setResults.php">
...
<script>
var latt = <?php echo $lat55?>;
var lngg = <?php echo $lng55?>;
...
<div>
    <input type = "text" id="rn1" name="rn1" value=""/>
    <input type = "text" id="rn2" name="rn2" value=""/>
    <input type = "text" id="rn3" name="rn3" value=""/>
    <input type = "text" id="rn4" name="rn4" value=""/>
    <input type = "text" id="rn5" name="rn5" value=""/>

    <input type = "text" id="lt1" name="lt1" value=""/>
    <input type = "text" id="lt2" name="lt2" value=""/>
    <input type = "text" id="lt3" name="lt3" value=""/>
    <input type = "text" id="lt4" name="lt4" value=""/>
    <input type = "text" id="lt5" name="lt5" value=""/>

    <input type = "text" id="ln1" name="ln1" value=""/>
    <input type = "text" id="ln2" name="ln2" value=""/>
    <input type = "text" id="ln3" name="ln3" value=""/>
    <input type = "text" id="ln4" name="ln4" value=""/>
    <input type = "text" id="ln5" name="ln5" value=""/>
